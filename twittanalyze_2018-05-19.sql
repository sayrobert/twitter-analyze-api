...
# Temps de génération: 2018-05-19 15:22:38 +0000
# ************************************************************
...
# Affichage de la table hashtags_history
# ------------------------------------------------------------

DROP TABLE IF EXISTS `hashtags_history`;

CREATE TABLE `hashtags_history` (
...
LOCK TABLES `hashtags_history` WRITE;
/*!40000 ALTER TABLE `hashtags_history` DISABLE KEYS */;

INSERT INTO `hashtags_history` (`id`, `hashtag_content`, `month`)
VALUES
...
/*!40000 ALTER TABLE `hashtags_history` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	...
	('997004005749469185','2018-05-17 06:40:53','','19438626','2018-05-18 13:40:04'),
	...
	('997238936308273154','2018-05-17 22:14:24','Dans #LEmissionPolitique : \n➡️Qui a été le plus convaincant ? Jean-Luc Mélenchon en tête avec 47 %.\n➡️Qui incarne l… https://t.co/xugAa0CRSe','80820758','2018-05-18 13:40:04'),
	...
	('997404857995874305','2018-05-18 09:13:43','','217749896','2018-05-18 13:40:05'),
	...
	('997750412601122816','2018-05-19 08:06:50','La #RDLS62 est en ligne ! \n\n➡️ https://t.co/B1q95l7Ago ⬅️\n\nLes thèmes : \n1️⃣ Lutte contre l\'#homophobie et la… https://t.co/pWP3UsYtUu','80820758','2018-05-19 10:10:56');
